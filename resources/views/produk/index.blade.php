            ...
            @if(Auth::user()->role === 'admin')
                <div class="mb-4">
                    <x-button
                        color="primary"
                        x-data=""
                        x-on:click="$dispatch('open-modal', 'modal-tambah-produk')"
                    >
                ...
                <table class="min-w-full">
                    <thead>
                        <tr class="border-b border-gray-100">
                            ...
                            <th class="table-th text-center align-middle pb-3 pt-3 pl-2">
                                Kode Produk
                            </th>
                    ...
                    <tbody>
                        @foreach($data as $produk)
                            <tr>
                                ...
                                <td class="py-2 px-4 border-b text-center">
                                    {{ $produk->kategori->name ?? 'Tidak ada kategori' }}
                                </td>
                                ...
                                <td class="py-2 px-4 border-b text-center">
                                    <x-button color="info">
                                        ...
                                        @elseif(Auth::user()->role === 'kasir')
                                            <a href="{{ route('kasir.produk.stock', $produk->id) }}">
                                                <i class="fas fa-eye"></i>
                                                Lihat Stok
                                            </a>
                                        @endif
                                ...
                                @if(Auth::user()->role === 'admin')
                                    <td class="py-2 px-4 border-b flex justify-center gap-2 items-center">
                                        ...
                                        <x-button
                                            color="warning"
                                            x-data=""
                                            x-on:click="$dispatch('open-modal', 'modal-edit-produk-{{ $produk->id }}')"
                                        >
                            ...
                            @if(Auth::user()->role === 'admin')
                                <x-modal
                                    name="modal-edit-produk-{{ $produk->id }}"
                                    focusable
                                >
                                    <form
                                    ...
                                    >
                                        ...
                                        <div class="space-y-6 pb-4 mx-2">
                                            ...
                                            <div>
                                                ...
                                                <x-input-error
                                                    :messages="$errors->get('kategori_id')"
                                                    class="mt-2"
                                                />
                                            </div>

...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    // Stok
    Route::get('/admin/produk/{id}/stock', [StokController::class, 'index'])
        ->name('admin.produk.stock');
    ...
    // Laporan
    Route::get('/admin/laporan-transaksi', [AdminController::class, 'laporanTransaksi'])
...
Route::middleware(['auth', 'role:kasir'])->group(function () {
    ...
    // Produk
    Route::get('/kasir/produk', [ProdukController::class, 'index'])
        ->name('kasir.produk');

    // Kategori
    Route::get('/kasir/kategori', [KategoriController::class, 'index'])
        ->name('kasir.kategori');

    // Lihat stok berdasarkan produk
    Route::get('/kasir/produk/{id}/stock', [StokController::class, 'index'])
        ->name('kasir.produk.stock');
